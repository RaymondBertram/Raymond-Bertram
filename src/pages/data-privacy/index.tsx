...
export default function DataPrivacy() {
  return (
    <div>
      <button className="flex flex-row shadow-md p-2">
      ...
      <p>
        ...
        Squarespace verarbeitet. Hierbei k&ouml;nnen auch personenbezogene Daten
        an das Mutterunternehmen von Squarespace, die Squarespace Inc., 8
        Clarkson St, New York, NY 10014, USA &uuml;bermittelt werden.
        Squarespace speichert ferner Cookies, die f&uuml;r die Darstellung der
        Seite und zur Gew&auml;hrleistung der Sicherheit erforderlich sind
        (notwendige Cookies).
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Sie hier:{" "}
        <a
          href="https://support.squarespace.com/hc/de/articles/360000851908-DSGVO-und-Squarespace"
          target="_blank"
      ...
      <p>
        ...
        <a
          href="https://www.dataprivacyframework.gov/s/participant-search/participant-detail?contact=true&id=a2zt0000000GnjcAAC&status=Active"
          target="_blank"
          rel="noopener noreferrer"
        >
