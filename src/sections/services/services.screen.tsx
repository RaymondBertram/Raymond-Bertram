    ...
    >
      ...
      <div className="flex flex-col gap-y-4">
        <div className="relative">
          <Image src={webCode} alt="bg" className="rounded-xl shadow-xl brightness-50 min-h-[180px] lg:max-w-96"/>
          <span className="absolute inset-0 flex items-center justify-center top-0 left-0 text-white text-2xl">Web Developement</span>
        </div>
        <div className="relative">
          <Image src={mobileApp} alt="bg" className="rounded-xl shadow-xl brightness-50 min-h-[180px] lg:max-w-96"/>
        ...
        <div className="relative">
          <Image src={shop} alt="bg" className="rounded-xl shadow-xl brightness-50 min-h-[180px] lg:max-w-96"/>
        ...
        <div className="relative">
          <Image src={design} alt="bg" className="rounded-xl shadow-xl brightness-50 min-h-[180px] lg:max-w-96"/>
        ...
        <div className="flex flex-col w-full bg-slate-100 rounded-xl shadow-xl py-7 lg:flex-row lg:justify-evenly lg:gap-x-10">
