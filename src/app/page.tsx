...
export default function App() {
  return (
    <main className="app-container flex min-h-screen flex-col items-center justify-between bg-gradient-to-b from-white via-slate-200 to-[#E2E2E2]">
      <section id="home" className="flex flex-col h-screen px-[20px] py-2 justify-center items-center">
        <Home/>
      </section>
      <section id="performance" className="flex flex-col min-h-full w-full px-[20px] py-2">
        <Service />
      </section>
